...
- 이용 표시: 제공 페이지에 **CC BY**로 표시되어 있어 출처와 가공 사실을 표기했다.
- **2026-09-11 추가 확인:** 페이지의 CCL 바로가기는 [BY-NC-ND 2.0 KR](https://creativecommons.org/licenses/by-nc-nd/2.0/kr/)로 연결된다. 표기와 링크가 상충하므로 가공·배포 허락이 확정되었다고 볼 수 없다. 출시 전 제공처 확인이 필요하다. 상세 점검은 `Docs/Release/ContentAttribution.md` 참조.
...
- 기존 #29 픽셀맵 위에서 시작한 후속 작업이다. PR #30 병합 후 최신 develop을 반영했으며, 이번 PR에는 경계 갱신 변경만 포함한다.

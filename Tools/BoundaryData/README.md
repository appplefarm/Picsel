...
- 라이선스: **CC BY (저작자 표시)**. 출처와 가공 사실을 표기한다.
- **2026-09-11 정리:** 사용자 확인에 따라 앱과 문서를 CC BY 기준으로 통일했다. 특정 라이선스 버전은 임의로 명시하지 않는다. 상세 고지는 `Docs/Release/ContentAttribution.md` 참조.
